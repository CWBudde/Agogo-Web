...
export function ToolOptions({ openBrushPresetImport }: { openBrushPresetImport: () => void }) {
  ...
  return (
    <div className="editor-chrome flex min-h-[42px] shrink-0 items-center justify-between gap-3 border-b border-border bg-chrome/70 px-2.5 py-1.5">
      <div className="flex min-w-0 items-center gap-2 overflow-x-auto pb-0.5">{content}</div>
      <div className="hidden shrink-0 text-[11px] text-muted-foreground xl:block">
