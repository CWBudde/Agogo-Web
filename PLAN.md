...
- [x] Add a golden-warning assertion per fixture — `warnings` is an exact order-insensitive set per sidecar; all 22 fixtures currently import with zero warnings
- [x] Keep fixture size bounded — `TestCorpusSizeBudget` enforces 128 KiB per file and 1 MiB total against soft targets of 24 KiB / 512 KiB; the corpus is ~118 KB of binaries across 22 files
